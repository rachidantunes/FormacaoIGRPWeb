...
public class Tbl_storeListView extends View {
	...
	public Tbl_storeListView(){
		...
		btn_new = new IGRPButton("New","gestao_compra","Tbl_storeList","new","modal|refresh","success|fa-plus","","");
		btn_new.propertie.add("rel","new").add("action-id","144").add("crud_op","addNew").add("type","specific");

		btn_update = new IGRPButton("Update","gestao_compra","Tbl_storeList","update","mpsubmit|refresh","warning|fa-pencil","","");
		btn_update.propertie.add("rel","update").add("action-id","144").add("crud_op","edit").add("type","form");

		btn_delete = new IGRPButton("Delete","gestao_compra","Tbl_storeList","delete","confirm","danger|fa-trash","","");
		btn_delete.propertie.add("rel","delete").add("action-id","145").add("crud_op","delete").add("type","form");
